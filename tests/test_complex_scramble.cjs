...
// Complex 15-move scramble (R U F' D L' B R' U' F D' L B' R U F')
// Generated with FIXED logic
const complexScrambleState = {
    "U": ["red", "red", "yellow", "yellow", "green", "green", "red", "green", "blue"],
    "D": ["white", "green", "orange", "red", "blue", "yellow", "green", "white", "yellow"],
    "L": ["green", "blue", "green", "yellow", "red", "white", "white", "blue", "orange"],
    "R": ["red", "yellow", "blue", "white", "orange", "blue", "yellow", "orange", "blue"],
    "F": ["yellow", "white", "white", "orange", "white", "blue", "blue", "orange", "green"],
    "B": ["red", "green", "white", "orange", "yellow", "red", "orange", "red", "orange"]
};

console.log('═══════════════════════════════════════');
console.log('  Test 3: Complex 15-Move Scramble');
console.log('═══════════════════════════════════════\n');
...
(async () => {
    ...
    try {
        ...
        console.log('4. Loading complex scramble state...');
        const textarea = await driver.wait(until.elementLocated(By.css('textarea')), TIMEOUTS.element);
        await textarea.clear();
        await textarea.sendKeys(JSON.stringify(complexScrambleState));
        ...
        // 15 moves = ~15-20s
        console.log('   Waiting 25s for animation...');
        await driver.sleep(25000);

        // Take screenshot
        const fs = require('fs');
        const screenshot = await driver.takeScreenshot();
        fs.writeFileSync('d:/Documents/Workspace/gemini/rubix-cube-solver/tests/test3_complex_final.png', screenshot, 'base64');
        console.log('   Screenshot saved: tests/test3_complex_final.png');
